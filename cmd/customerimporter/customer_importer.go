...
import (
	"TeamworkTT/cmd/customerimporter/domaincounter"
	"TeamworkTT/cmd/customerimporter/importer"
	"TeamworkTT/cmd/customerimporter/sorter"
	"TeamworkTT/internal/variables"
	"bytes"
	"fmt"
	sort2 "sort"
	"strings"
